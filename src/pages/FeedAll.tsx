...
const ALL_FEED_ITEMS: FeedItem[] = [
  ...
  {
    id: "7", user: "ms", seed: "ms", time: "48분 전",
  ...
  {
    id: "8", user: "sm", seed: "sm", time: "1시간 전",
  ...
  {
    id: "11", user: "ms", seed: "ms", time: "2시간 전",
  ...
  {
    id: "12", user: "sm", seed: "sm", time: "3시간 전",
  ...
  {
    id: "16", user: "sm", seed: "sm", time: "6시간 전",
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <div className="flex flex-col gap-2.5">
            {ALL_FEED_ITEMS.filter((_, i) => i % 2 === 0).map((item) => (
              <React.Fragment key={item.id}><FeedCard item={item} /></React.Fragment>
            ))}
          </div>
          {/* 오른쪽 컬럼 — 위로 오프셋 */}
