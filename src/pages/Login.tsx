    ...
    <div className="flex flex-col h-full bg-white dark:bg-[#0F1117] relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto relative z-10">
        ...
        <div className="flex items-center gap-4 px-6 mb-5">
          ...
          <span className="text-slate-400 dark:text-white/30 text-[12px] font-medium">또는 소셜 로그인</span>
          <div className="h-px bg-slate-200 dark:bg-white/10 flex-1" />
        </div>
        ...
        <div className="px-6 mb-5 flex gap-3">
          ...
          <button
            type="button"
            onClick={() => setError("소셜 로그인은 아직 준비 중이에요. 이메일 로그인을 사용해주세요.")}
            className="flex-1 h-14 flex items-center justify-center rounded-2xl bg-white hover:bg-slate-50 border border-slate-200 dark:border-white/20 transition-all active:scale-[0.97]"
          >
          ...
          <button
            type="button"
            onClick={() => setError("소셜 로그인은 아직 준비 중이에요. 이메일 로그인을 사용해주세요.")}
            className="flex-1 h-14 flex items-center justify-center rounded-2xl bg-slate-900 dark:bg-black hover:bg-black/80 border border-slate-800 dark:border-white/10 transition-all active:scale-[0.97]"
          >
