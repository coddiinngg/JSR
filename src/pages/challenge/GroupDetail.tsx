                  ...
                  return (
                    <div key={rank}
                      ...
                      style={{
                        ...
                        paddingBottom: 14,
                        background: isMe ? "linear-gradient(160deg,rgba(255,51,85,0.08),white)" : "white",
                        border: isMe ? "1.5px solid rgba(255,51,85,0.2)" : "1px solid rgba(0,0,0,0.06)",
                        boxShadow: isMe ? "0 6px 24px rgba(255,51,85,0.12)" : "0 2px 10px rgba(0,0,0,0.04)",
                        opacity: mounted ? 1 : 0,
